...
(кстати если у print_flag и ret_addr совпадут младшие байты, но не совпадут старшие, то младшие байты нужно будет поксорить на 0, а старшие нет - и из-за strlen это невозможно... но так не будет)